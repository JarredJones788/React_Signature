...
export default function MultiPageViewer(props: IProps) {
    ...
    return (
        <div id="signature-document-box" className={classes.documentBox} onScroll={() => { checkPageScroll(setDocumentState); }}>
            <SignatureToolbar currentPage={documentState.currentScrolledPage} prevPage={prevPage} nextPage={nextPage} saveDocument={saveDocument} scale={documentScale} decreaseScale={decreaseScale} increaseScale={increaseScale} addInput={addInput} />
