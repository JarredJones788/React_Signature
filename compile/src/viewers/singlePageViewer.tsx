...
export default function SinglePageViewer(props: IProps) {
    ...
    return (
        <div id="signature-document-box" className={classes.documentBox}>
            <SignatureToolbar currentPage={documentState.currentPage} prevPage={prevPage} nextPage={nextPage} saveDocument={saveDocument} scale={documentScale} decreaseScale={decreaseScale} increaseScale={increaseScale} addInput={addInput} />
